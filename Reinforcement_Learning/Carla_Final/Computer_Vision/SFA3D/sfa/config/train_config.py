...
def parse_train_configs():
    ...
    parser.add_argument('--saved_fn', type=str, default='fpn_resnet', metavar='FN',
    ...
    parser.add_argument('--pretrained_path', type=str, default='../checkpoints/Model_100.pth', metavar='PATH',
