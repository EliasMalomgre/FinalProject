...
def parse_test_configs():
    ...
    parser.add_argument('--pretrained_path', type=str,
                        default='../checkpoints/Model_100.pth', metavar='PATH',
...
if __name__ == '__main__':
    ...
    # load utils from checkpoint
    # model_utils = torch.load(configs.pretrained_path, map_location='cpu')['model_utils']
    ...
    with torch.no_grad():
        for batch_idx, batch_data in enumerate(test_dataloader):
            ...
            kitti_dets = convert_det_to_real_values(detections, num_classes=configs.num_classes)
