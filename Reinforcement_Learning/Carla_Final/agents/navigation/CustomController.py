...
from Carla_Final.Utils.utils import get_speed
...
class CustomVehicleController():
    ...
    def run_step(self, target_speed, waypoint, action):
        """
        ...
        acceleration = action  # self._lon_controller.run_step(target_speed)
    ...
    def set_vehicle(self, vehicle):
        self._vehicle = vehicle
        self._lat_controller.set_vehicle(vehicle)
        self._lon_controller.set_vehicle(vehicle)
